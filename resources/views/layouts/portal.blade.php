...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white ">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center lh-1 me-1 transition-opacity opacity-75-hover"
                href="{{ route('home') }}">
            ...
            <div class="collapse navbar-collapse justify-content-evenly" id="navbarSupportedContent">
                <ul class="navbar-nav" style="gap: 0.3rem;">
                    <li class="nav-item dropdown position-static ">
                        <a class="nav-link dropdown-toggle me-lg-0 ms-lg-0" href="#" role="button"
                                ...
                                <div class="row py-lg-5 gx-8">
                                    <div class="col-auto me-4 mb-4 col-lg-4 d-flex align-items-start">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <a href="{{ route('certificados.emitir') }}"
                                                class="fw-medium fs-7 text-decoration-none link-cover">Acessar
                                                &rarr;</a>
                                        </div>
                                    </div>
                                    <div class="col-auto me-4 mb-4 col-lg-4 d-flex align-items-start">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-lg-0 ms-lg-0" href="{{ route('projeto.indexPublic') }}"
                            style="font-size: 1.2rem;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-lg-0 ms-lg-0" href="{{ route('noticias.cards') }}"
                            style="font-size: 1.2rem;">
                            <i class="ri-newspaper-line me-2"></i>
                            <span>Notícias</span>
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-lg-0 ms-lg-0" href="{{ route('galeria.indexPublic') }}"
                            style="font-size: 1.2rem;">
    ...
    <footer class="bg-dark pt-4 pb-8">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                <a class="d-flex align-items-center lh-1 text-white transition-opacity opacity-50-hover text-decoration-none mb-4 mb-md-0"
                    ...
                    <span class="f-w-7 d-block text-success me-2">
                        <img class="img-fluid d-table mx-auto bg-white rounded-1"
                            src="{{ asset('img/codelab-logo-ico.png') }}" alt="">
                    </span>
        ...
        <div class="container">
            <div
                ...
                <span class="small text-white opacity-50 mb-2 mb-md-0">Todos os direitos reservados &copy IFPR 2024 e
                    Sigma 2021</span>
