<!doctype html>t<html lang="en">uo<!-- Head --> <head>e    <!-- Page Meta Tags-->
    <meta charset="utf-8">
    ...
    <!-- <link rel="stylesheet" href="@vite('resources/css/libs.bundle.css')" /> -->


    <!-- Main CSS -->
    @vite('resources/css/theme.bundle.css')
    <!-- <link rel="stylesheet" href="@vite('resources/css/theme.bundle.css')" /> -->
            ...
            <div class="container py-4">
                ...
                <div class="row gx-10 gy-7 mt-4">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 d-flex flex-column align-items-center justify-content-center" data-aos="fade-in" data-aos-duration="500" data-aos-delay="500">
                        ...
                        <p class="text-white fs-4 fw-medium mb-2 mt-3">Gitlab</p>
                        <p class="text-white opacity-75 text-center fs-7">Automatically track commits, merges and pull requests with our activity feed.</p>
                    </div>
                    <!-- /Integration-->
                </div>
                        ...
                        <div class="position-absolute bottom-5 end-0 z-index-30 d-none d-lg-block">
                                ...
                                <div class="position-relative me-4">
                                    <picture class="position-relative z-index-0">
                                        <img class="f-w-12 rounded-circle"
                                            src="./assets/images/profile-small-2.jpeg" alt="HTML Bootstrap Template by Pixel Rocket">
                                    </picture>
                                    <span
                            ...
                            <div
                                ...
                                <div class="position-relative me-4">
                                    <picture class="position-relative z-index-0">
                                        <img class="f-w-12 rounded-circle"
                                            src="./assets/images/profile-small-3.jpeg" alt="HTML Bootstrap Template by Pixel Rocket">
                                    </picture>
                                    <span
                    ...
                    <div class="col-12 col-md-6 col-xl-5 offset-xl-1 position-relative" data-aos="fade-in">
                        ...
                        <div class="position-absolute bottom-3 start-5 z-index-30 d-none d-lg-block" data-aos="fade-in" data-aos-duration="350" data-aos-delay="200">
                            <div class="p-3 bg-white shadow-lg rounded-3 f-w-16 mb-3">
                                <picture class="position-relative z-index-0">
                                    <img class="img-fluid" src="./assets/images/logos/logo-12.svg" alt="HTML Bootstrap Template by Pixel Rocket">
                                </picture>
                            </div>
                            <div class="p-3 bg-white shadow-lg rounded-3 f-w-16 mb-3">
                                <picture class="position-relative z-index-0">
                                    <img class="img-fluid" src="./assets/images/logos/logo-10.svg" alt="HTML Bootstrap Template by Pixel Rocket">
                                </picture>
                            </div>
                            <div class="p-3 bg-white shadow-lg rounded-3 f-w-16 mb-3">
                                <picture class="position-relative z-index-0">
                                    <img class="img-fluid" src="./assets/images/logos/logo-11.svg" alt="HTML Bootstrap Template by Pixel Rocket">
                                </picture>
                            </div>
                        ...
                        <div class="marquee-section animation-marquee-200 py-3">
                            <div class="rounded shadow-sm border f-w-76 d-flex flex-wrap flex-column px-5 pb-5 pt-7 mx-4 text-wrap position-relative h-100">
                                ...
                                <div class="mt-4 f-w-20">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="./assets/images/logos/logo-15.svg" alt="">
                                    </picture>
                                </div>
                            </div>
                            <div class="rounded shadow-sm border f-w-76 d-flex flex-wrap flex-column px-5 pb-5 pt-7 mx-4 text-wrap position-relative h-100">
                                ...
                                <div class="mt-4 f-w-20">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="./assets/images/logos/logo-16.svg" alt="">
                                    </picture>
                                </div>
                            </div>
                            <div class="rounded shadow-sm border f-w-76 d-flex flex-wrap flex-column px-5 pb-5 pt-7 mx-4 text-wrap position-relative h-100">
                                ...
                                <div class="mt-4 f-w-20">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="./assets/images/logos/logo-17.svg" alt="">
                                    </picture>
                                </div>
                            </div>
                            <div class="rounded shadow-sm border f-w-76 d-flex flex-wrap flex-column px-5 pb-5 pt-7 mx-4 text-wrap position-relative h-100">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <picture>
                                        <img class="f-w-10 rounded-circle"
                                            src="./assets/images/profile-small-5.jpeg" alt="">
                                    </picture>
                                    <span class="d-block text-muted fs-7 ms-3">Rohit Sharma</span>
                                </div>
                                <div class="mt-4 f-w-20">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="./assets/images/logos/logo-18.svg" alt="">
                                    </picture>
                                </div>
                            </div>
                            <div class="rounded shadow-sm border f-w-76 d-flex flex-wrap flex-column px-5 pb-5 pt-7 mx-4 text-wrap position-relative h-100">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <picture>
                                        <img class="f-w-10 rounded-circle"
                                            src="./assets/images/profile-small-6.jpeg" alt="">
                                    </picture>
                                    <span class="d-block text-muted fs-7 ms-3">Jeff Waite</span>
                                </div>
                                <div class="mt-4 f-w-20">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="./assets/images/logos/logo-19.svg" alt="">
                                    </picture>
                                </div>
                            </div>
                            <div class="rounded shadow-sm border f-w-76 d-flex flex-wrap flex-column px-5 pb-5 pt-7 mx-4 text-wrap position-relative h-100">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <picture>
                                        <img class="f-w-10 rounded-circle"
                                            src="./assets/images/profile-small-7.jpeg" alt="">
                                    </picture>
                                    <span class="d-block text-muted fs-7 ms-3">Kinsta Troy</span>
                                </div>
                                <div class="mt-4 f-w-20">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="./assets/images/logos/logo-20.svg" alt="">
                                    </picture>
                                </div>
                            </div>
                            <div class="rounded shadow-sm border f-w-76 d-flex flex-wrap flex-column px-5 pb-5 pt-7 mx-4 text-wrap position-relative h-100">
                                ...
                                <div class="mt-4 f-w-20">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="./assets/images/logos/logo-21.svg" alt="">
                                    </picture>
                                </div>
                            </div>
                            <div class="rounded shadow-sm border f-w-76 d-flex flex-wrap flex-column px-5 pb-5 pt-7 mx-4 text-wrap position-relative h-100">
                                ...
                                <div class="mt-4 f-w-20">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="./assets/images/logos/logo-22.svg" alt="">
                                    </picture>
                                </div>
                            </div>
                        </div>
